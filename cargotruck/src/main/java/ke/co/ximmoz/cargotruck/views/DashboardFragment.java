...
public class DashboardFragment extends Fragment {
    ...
    @BindView(R.id.availableconsignments)
    FrameLayout availableconsignments;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        availableconsignments.setOnClickListener((v)->{

            navController.navigate(R.id.action_dashboardFragment_to_consignmentsFragment);
