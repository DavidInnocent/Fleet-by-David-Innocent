...
public class BankDetailsFragment extends Fragment {
    ...
    @OnClick(R.id.finish_close) void finish()
    {
        navController.popBackStack(R.id.consignmentsHistoryFragment,false);
    }
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        consignment=BankDetailsFragmentArgs.fromBundle(getArguments()).getConsignmentDetails();
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        if(consignment!=null)
        {
            ...
            orderAmount.setText(consignment.getAmount());
            return;
        }
        Toast.makeText(getActivity(), "NO COnsignment", Toast.LENGTH_SHORT).show();
    }
}